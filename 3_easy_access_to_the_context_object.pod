...
L<local|http://perldoc.perl.org/functions/local.html> keyword, a global 
...
Also, note that this will B<not> work under async scenarios -- only when you are deploying
